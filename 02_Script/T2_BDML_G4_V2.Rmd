...
##2.6 Optimización de umbral para maximizar F1 Score
```{r}
...
##2.7 Crear la curva ROC para prediccion train set Elastic Net
```{r}
# Crear objeto ROC
...
##2.9 Metricas Modelo Elastic Net
```{r}
# Calcular métricas
...
##2.10 Explorar la importancia de las variables
```{r}
