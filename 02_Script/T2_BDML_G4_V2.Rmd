...
```{r}
## Template_RF
write.csv(resultados_prediccion_rf, "../05_Predictions/080425sample_equipo4_rf.csv", 
          row.names = FALSE,
          quote = FALSE)
```
...
```{r}
## Template_RF
write.csv(resultados_prediccion_rf_cv, "../05_Predictions/080425sample_equipo4_rf_cv.csv", 
          row.names = FALSE,
          quote = FALSE)
```
