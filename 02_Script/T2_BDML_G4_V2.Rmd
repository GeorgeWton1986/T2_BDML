...
##2.7 Entrenar el modelo Elastic Net con Caret variables importantes
```{r}
...
##2.8 Predicción modelo Elastic Net
```{r}
...
##2.9 Optimización de umbral para maximizar F1 Score
```{r}
...
##2.10 Crear la curva ROC para prediccion train set Elastic Net
```{r}
# Crear objeto ROC
...
##2.12 Metricas Modelo Elastic Net
```{r}
# Calcular métricas
...
##2.13 Prediccion con el Test Set Elastic Net
```{r}
...
##2.14 Gráficos de la predicción
```{r}
