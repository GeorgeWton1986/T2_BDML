...
##2.7 Predicción modelo Elastic Net
```{r}
...
##2.8 Optimización de umbral para maximizar F1 Score
```{r}
...
##2.9 Crear la curva ROC para prediccion train set Elastic Net
```{r}
# Crear objeto ROC
...
##2.11 Metricas Modelo Elastic Net
```{r}
# Calcular métricas
...
##2.12 Prediccion con el Test Set Elastic Net
```{r}
...
##2.13 Gráficos de la predicción
```{r}
