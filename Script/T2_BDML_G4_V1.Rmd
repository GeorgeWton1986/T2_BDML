...
TN <- A[1]  # Verdaderos Negativos
FP <- A[2]  # Falsos Positivos
FN <- A[3]  # Falsos Negativos
TP <- A[4]  # Verdaderos Positivos
...
# Precisión
Precision <- A[4]/(A[2] + A[4])

# Recall (Sensibilidad)
Recall <- A[4]/(A[3] + A[4])

# Especificidad
Specificity <- A[1]/(A[1] + A[2])
