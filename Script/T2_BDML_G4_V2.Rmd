...
## 4.4 Entrenamiento fuera de muestra cross validation con ranger
```{r}
# Fijar semilla
set.seed(123)
...
## 4.5 Entrenamiento del modelo para buscar la mejor combinación de parámetros, se usa ranger con cross validation
...
## 4 Predicciones con ranger y randomForest
```{r}
